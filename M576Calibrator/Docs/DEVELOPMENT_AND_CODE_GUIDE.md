...
| [`PeakFinder.md`](PeakFinder.md) | 两轴交叉寻峰算法、Y 预扫重试与 planner 策略说明 |
| [`peakFinderEmergency.md`](peakFinderEmergency.md) | **寻峰算法紧急回退 SOP**（L0=`0f80f0f` 无拼接/mesa；IL 不达标时手术式回退步骤） |
